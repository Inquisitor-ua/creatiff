            ...
            },
            {
                ...
                'stream_data': [
                    ...
                    {"type": "gallery", "value": {'title': '', 'images': [
                        self.get_or_create_seed_image('content4_img1.png'),
                        self.get_or_create_seed_image('content4_img2.png'),
                        self.get_or_create_seed_image('content4_img3.png'),
                        self.get_or_create_seed_image('content4_img4.png'),
                    ]}},
                    ...
                    {"type": "gallery", "value": {'title': 'Colors:', 'images': [
                        self.get_or_create_seed_image('content4_img12.png'),
                        self.get_or_create_seed_image('content4_img13.png'),
                        self.get_or_create_seed_image('content4_img14.png'),
                        self.get_or_create_seed_image('content4_img15.png'),
                        self.get_or_create_seed_image('content4_img12.png'),
                    ]}},
                    ...
                    {"type": "gallery", "value": {'title': 'Standard Door Gallery', 'images': [
                        self.get_or_create_seed_image('content4_img19.png'),
                        self.get_or_create_seed_image('content4_img20.png'),
                        self.get_or_create_seed_image('content4_img21.png'),
                        self.get_or_create_seed_image('content4_img22.png'),
                    ]}},
                    {"type": "gallery", "value": {'title': 'Gallery of Double Doors', 'images': [
                        self.get_or_create_seed_image('content4_img23.png'),
                        self.get_or_create_seed_image('content4_img24.png'),
                        self.get_or_create_seed_image('content4_img25.png'),
                        self.get_or_create_seed_image('content4_img23.png'),
                    ]}},
